...
To use the Viking Character Pack, you can simply drag the model (in folder "Models") or the prefab (in folder "Prefabs") into the scene.


LICENSE

Thank you for buying the Viking Character Pack! 
